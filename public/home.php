    ...
    <div id="sidebar">
        <div class="accordion" id="accordionCapas">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseEfectores" class="accordion-collapse collapse"
                     aria-labelledby="headingEfectores" data-bs-parent="#accordionCapas">
                    <div class="accordion-body" id="grupo-efectores">
                        <!-- Checkboxes de capas se cargarán aquí dinámicamente -->
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseDivTerr" class="accordion-collapse collapse"
                     aria-labelledby="headingDivTerr" data-bs-parent="#accordionCapas">
                    <div class="accordion-body" id="grupo-divisiones_territoriales">
                        <!-- Futuras capas de divisiones territoriales -->
                    </div>
                </div>
            </div>
